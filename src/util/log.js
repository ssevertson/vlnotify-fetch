/*
 * HACK: Pull flatiron/broadway's log plugin into the project, so it loads the desired Winston version.
 * HACK: Use flatiron/utile instead of common
 * 
...
log.attach = function (options) {
  ...
  if (this.config) {
    ...
    //
    options = utile.mixin({}, options, this.config.get('log') || {});
  }
